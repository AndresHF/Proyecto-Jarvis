...
weatherConstants = ["tiempo", "temperatura"]

whoAmI = "Soy María, un asistente que controla el ordenador por comandos de voz"

purpose = "Servir a mi creador Andrés, funcionar bien durante la exposición e impresionar a los profesores Javier Pérez y Sonia Aranda"
